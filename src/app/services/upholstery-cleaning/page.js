...
import { upholsteryFaqs } from "@/lib/upholstery-cleaning";

const canonicalUrl = `${businessInfo.siteUrl}/services/upholstery-cleaning/`;
const metadataDescription =
  "Professional upholstery cleaning in Bolingbrook and nearby Chicago suburbs. View starting prices, cleaning steps and request a quote from NovaFiber.";
const socialImage = `${businessInfo.siteUrl}/image/services/upholstery-cleaning.jpg`;

export const metadata = {
  title: "Upholstery Cleaning in Bolingbrook, IL | NovaFiber",
  ...
  openGraph: {
    ...
    images: [
      {
        url: socialImage,
        alt: "NovaFiber upholstery cleaning service",
      },
    ],
  },
  twitter: {
...
const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      serviceType: "Professional upholstery cleaning",
      url: canonicalUrl,
      description: metadataDescription,
...
const upholsteryQuoteMessage = `Hi NovaFiber! I'd like an upholstery cleaning quote.

City / ZIP:
Upholstered item(s) to be cleaned:
Number of items:
...
const processSteps = [
  {
    title: "Inspection",
    description:
      "We inspect the item, upholstery, construction, care label and problem areas before cleaning.",
  },
  {
    title: "Fabric & Condition Check",
    description:
      "The material, color stability and overall condition are evaluated to determine an appropriate cleaning approach.",
  },
  {
    title: "Pre-Treatment",
    description:
      "Compatible stains and heavily soiled contact areas may be treated before the main cleaning process when appropriate.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Each cleaned item is reviewed after the service and any remaining limitations are discussed with the customer.",
  },
];
    ...
    <>
      ...
      <section className="w-full bg-white pb-10 desktop:pb-20">
        <Hero
          ...
          title="Professional Upholstery Cleaning in Bolingbrook, IL"
          description="Professional deep cleaning for upholstered chairs, armchairs, ottomans, dining chairs and other compatible fabric furniture in Bolingbrook and surrounding Chicago suburbs. We help remove built-up dirt, everyday spills, stains and odors using cleaning methods selected for the material and condition of each item."
          primaryAction={{
            type: "responsiveQuote",
            message: upholsteryQuoteMessage,
          }}
          secondaryAction={{ label: "Call Us", href: contactLinks.telephone }}
          backgroundImage="/image/services/upholstery-cleaning.jpg"
        ...
        <div className="mx-auto max-w-5xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 leading-relaxed text-gray-600">
              Upholstery cleaning is a good option for fabric-covered furniture
              affected by everyday dirt, spills, visible stains, odors and
        ...
        <div className="mx-auto w-full">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-gray-600">
              Examples of professional upholstery cleaning results.
            </p>
          </div>
          <div className="mt-10 grid grid-cols-1 gap-7 md:grid-cols-2">
            <ServiceImage
              src="/image/services/upholstery/result_1.jpg"
              alt="Upholstered furniture before professional cleaning"
              placeholderLabel="Before-cleaning upholstery result image coming soon"
              badge="BEFORE"
            />
            <ServiceImage
              src="/image/services/upholstery/result_2.jpg"
              alt="Upholstered furniture after professional cleaning"
              placeholderLabel="After-cleaning upholstery result image coming soon"
              badge="AFTER"
              badgePosition="right"
            />
          </div>
        ...
        <article className="mx-auto max-w-5xl rounded-4xl border border-gray-200 bg-white px-6 py-7 shadow-sm sm:px-8">
          ...
          <div className="mt-6 border-t border-gray-200 pt-5">
            <p className="text-sm leading-relaxed text-gray-600">
              Need a more accurate price? Send us photos of each item and
      ...
      <section className="w-full max-w-360 bg-white px-5 py-10 sm:px-10 md:px-20 desktop:py-20">
        <div className="mx-auto grid max-w-5xl gap-7 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-5 leading-relaxed text-gray-600">
              Professional cleaning can significantly improve the appearance
              and condition of many upholstered items, but not every stain,
              odor or discoloration can be fully removed. Results depend on the
              material, construction, type and age of the stain, previous
              cleaning attempts and overall condition. Delicate materials or
              deep contamination may require a different approach or may not be
          ...
          >
            ...
            <p className="mt-5 leading-relaxed text-gray-600">
              Allow cleaned upholstery to dry fully before normal use. Drying
              time varies depending on the material, item construction, room
              temperature, humidity, airflow and the amount of moisture used
              during cleaning.
            </p>
          </article>
        </div>
      ...
      <section className="w-full max-w-360 bg-[#F7F7F7] px-5 py-10 sm:px-10 md:px-20 desktop:py-20">
        <aside className="mx-auto max-w-5xl rounded-4xl border border-amber-200 bg-white px-6 py-8 shadow-sm sm:px-8 md:px-10 md:py-10">
          ...
          <h2 className="text-3xl font-bold sm:text-4xl">
            Send Us Photos of Your Upholstered Furniture
          </h2>
          <p className="mt-5 max-w-4xl leading-relaxed text-gray-600">
            Send us photos of the full item and close-up photos of any stains or
            problem areas. Tell us your city, the number of items and whether
            there are any odors. We&apos;ll review the details and provide a
            more accurate quote before scheduling.
          </p>
          ...
          <p className="mt-7 text-sm leading-relaxed text-gray-600">
            For the best estimate, include photos of every item and close-up
      ...
      <section
        aria-labelledby="upholstery-faq-heading"
        className="w-full max-w-360 bg-white px-5 py-10 sm:px-10 md:px-20 desktop:py-20"
      >
        <div className="mx-auto w-full">
          <div className="mx-auto max-w-3xl text-center">
            <h2
              id="upholstery-faq-heading"
              className="text-3xl font-bold sm:text-4xl"
            >
              Frequently Asked Questions
            </h2>
            <p className="mt-5 leading-relaxed text-gray-600">
              Helpful details about professional upholstery cleaning.
            </p>
          </div>
          <ServiceFAQ faqs={upholsteryFaqs} idPrefix="upholstery-faq" />
        </div>
      </section>
    </>
  );
